                              ...
                              <div className="flex items-start gap-4">
                                  ...
                                  <div className="flex-1">
                                      <div className="flex items-center justify-between">
                                          ...
                                          <p className="text-sm text-slate-300">@ · 0h</p>
                                          </div>
                                      </div>
                                      <p className="text-white mt-3 mb-4">Posts</p>
                          ...
                          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                              <div className="flex items-start gap-4">
                                  ...
                                  <div className="flex-1">
                                      ...
                                      <p className="text-white mt-3 mb-4">I AM MUSIC</p>
                                      <div className="flex items-center gap-6 text-slate-300">
                                          <button className="flex items-center gap-2 hover:text-red-400 transition-colors duration-300">
                                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                                              <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                          ...
                          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                              <div className="flex items-start gap-4">
                                  ...
                                  <div className="flex-1">
                                      ...
                                      <p className="text-white mt-3 mb-4">This would be a song</p>
                                      <div className="flex items-center gap-6 text-slate-300">
                                          <button className="flex items-center gap-2 hover:text-red-400 transition-colors duration-300">
                                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                                              <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                          ...
                          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                              <div className="flex items-start gap-4">
                                  ...
                                  <div className="flex-1">
                                      ...
                                      <p className="text-white mt-3 mb-4">likes</p>
                                      <div className="flex items-center gap-6 text-slate-300">
                                          <button className="flex items-center gap-2 hover:text-red-400 transition-colors duration-300">
                                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                                              <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
            ...
            <div className="col-span-12 lg:col-span-5">
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                ...
                <div className="flex flex-col gap-4">
                  {[
                    { rank: 1, song: "String Theocracy", artist: "Mili" },
                    { rank: 2, song: "Survive", artist: "Jorge Rivera-Herrans" },
                    { rank: 3, song: "Lord of Chaos", artist: "Ken Carson" },
                    { rank: 4, song: "From the Start", artist: "Laufey" },
                    { rank: 5, song: "Iron Lotus", artist: "Mili" },
                  ].map((item, index) => (
